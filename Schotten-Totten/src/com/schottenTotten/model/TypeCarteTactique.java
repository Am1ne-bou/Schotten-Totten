...
public enum TypeCarteTactique {
    ...
    public boolean isTroupeElite() { return categorie==TypeCategorie.TROUPE_ELITE; }
    public boolean isModeCombat() { return categorie==TypeCategorie.MODE_COMBAT; }
    public boolean isRuse() { return categorie==TypeCategorie.RUSE; }

    public enum TypeCategorie {
        TROUPE_ELITE("Troupe d'Élite"),
        MODE_COMBAT("Mode de Combat"),
        RUSE("Ruse");

        private final String nom;
        TypeCategorie(String nom) { this.nom=nom; }
        public String getNom() { return nom; }
    }
}