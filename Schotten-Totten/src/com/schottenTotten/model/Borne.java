...
public class Borne {
    private final List<Carte> cartesJ1;
    private final List<Carte> cartesJ2;
    ...
    public boolean hasColinMaillard() {
        return colinMaillard;
    }

    public boolean hasCombatDeBoue() {
        return combatDeBoue;
    }
    ...
    public void setColinMaillard(boolean colinMaillard) {
        this.colinMaillard = colinMaillard;
    }

    public void setCombatDeBoue(boolean combatDeBoue) {
        this.combatDeBoue = combatDeBoue;
    }
