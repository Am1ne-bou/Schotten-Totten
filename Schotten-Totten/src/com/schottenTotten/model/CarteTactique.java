...
public class CarteTactique extends Carte {
    ...
    public Integer getValeurChoisie() {
        return valeurChoisie;
    }

    public Couleur getCouleurChoisie() {
    ...
    public void setValeurChoisie(Integer valeur) {
        this.valeurChoisie = valeur;
    }

    public void setCouleurChoisie(Couleur couleur) {
